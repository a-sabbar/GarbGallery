...
function Header() {
    ...
    return (
        <div className="fixed top-0 left-0 z-50 flex items-center justify-between w-screen p-5 px-6 py-2 bg-white lg:items-end lg:py-4">
            <Link href={"/"} style={RobotoFont.style} className='hidden text-5xl font-semibold lg:block'>
                GarbGallery
            </Link>
            <Link href={"/"} style={RobotoFont.style} className='z-50 text-5xl font-semibold lg:hidden'>
                <svg width="332" height="236" viewBox="0 0 332 236" fill="none" xmlns="http://www.w3.org/2000/svg" className='w-[70px] h-[70px] fill-black'>
                    <path d="M157 46C141 34.5 115.69 31.0536 99.4683 33.6482C83.2468 36.2428 68.0987 43.4898 55.8507 54.5152C43.6026 65.5407 34.7775 79.8739 30.4395 95.7866C26.1015 111.699 26.4358 128.512 31.4021 144.197C36.3684 159.883 45.7547 173.772 58.4291 184.189C71.1035 194.606 86.5249 201.106 102.834 202.907C119.143 204.707 135.643 201.73 150.345 194.335C165 187.5 177 175.5 187.5 162L139 117C131.5 111 119 108 110 115C110 115 108.5 115.5 99 125.5C108.5 137 139 161 138 164C128.935 168.56 116.595 171.465 106.539 170.355C96.4825 169.245 86.9734 165.236 79.1582 158.813C71.3429 152.39 65.5552 143.826 62.4929 134.154C59.4306 124.482 59.2245 114.115 61.8994 104.303C64.5742 94.491 70.0159 85.6529 77.5683 78.8545C85.1206 72.056 94.4611 67.5874 104.464 65.9875C114.5 65 125.059 66.1498 133.5 70L157 46Z"/>
                    <path d="M139.503 73.8023C150.999 58.9994 162.499 49.4994 176.999 41.9994C192.383 34.7438 210.677 31.4853 227.499 33.9994C243.499 36.3906 258.452 43.0004 271.043 54.4368C283.633 65.8732 293.884 80.9955 297.999 97.4994C302.114 114.003 300.248 131.991 294.5 148C288.752 164.008 278.5 177.5 264.374 187.227C250.701 197.345 234.335 203.18 217.345 203.997C200.356 204.813 184.079 199.26 169.499 190.499L193.502 165.997C202.503 169.496 205.499 170.999 215.999 169.999C226.471 169.496 237.072 167.235 245.499 160.999C253.927 154.763 260.831 145.366 264.374 135.499C267.917 125.632 268.035 114.672 265.499 104.499C262.963 94.3271 256.259 85.0483 248.499 77.9994C240.739 70.9505 231.368 67.549 220.999 65.9994C210.631 64.4498 197.982 68.528 188.5 73L227.499 111C224.5 113.5 212 134.5 190 121L178 110.5L164.751 97.4012L139.503 73.8023Z"/>
                </svg>
            </Link>

            <div className=" flex-col justify-center h-fit items-center z-40 gap-[5px] pr-2 lg:hidden flex cursor-pointer " onClick={() => setIsOpened(!isOpened)}>
                <motion.div
                    animate={!isOpened ? { rotate: 0 } : { rotate: 45 , y: 9 , x: 1, transition: { duration: 0.1 , type:"spring" } }}
                className="w-[45px] h-[4px] bg-[#000] z-40  transition-all duration-500 rounded-md"></motion.div>
                <motion.div
                    animate={!isOpened ? { scaleX: 1 , transition: { duration: 0.5 } } : { scaleX: 0}}
                className="w-[35px] h-[4px] bg-[#000] z-40 transition-all duration-150 rounded-md"></motion.div>
                <motion.div
                    animate={!isOpened ? { rotate: 0 } : { rotate: -45 , y: -9 , x: 1,  transition: { duration: 0.1, type:"spring" } }}
                className="w-[45px] h-[4px] bg-[#000] z-40  transition-all duration-500 rounded-md"></motion.div>
                <AnimatePresence>
                    {
                        ...
                        <motion.div
                            ...
                            exit={!isOpened ? { opacity: 0 } : { opacity: 1 }}
                            className='absolute  top-0 left-0 w-screen h-[100vh]  z-30  pt-[80px] '>
                            <div className='relative w-full h-full '>
                                <div className='absolute top-0 left-0 grid w-full h-full grid-cols-4 gap-0 -z-10'>
                                    <motion.div 
                                        variants={menuChild}
                                        initial='initial'
                                        animate='animate'
                                        exit='exit'
                                        className='w-full  h-full bg-[#FFF] flex   justify-between flex-col flex-nowrap gap-10 px-6 overflow-hidden py-6'>
                                            </motion.div>
                                    <motion.div 
                                        variants={menuChild1}
                                        initial='initial'
                                ...
                                <motion.div
                                className='flex flex-col justify-between w-full h-full p-5 py-5'>
                                    <motion.div
                                    initial={{ opacity: 0 ,}}
                                    animate={{ opacity: 1 , transition: { delay: 0.7 , duration: 0.1 } }}
                                    exit={{ opacity: 0 ,transition: { duration: 0.1 } }}
                                     className='flex flex-wrap gap-10 justify'>

                                        <div  className='flex flex-col gap-4 w-[120px] h-fit'>
                                 ...
                                 className='flex flex-col justify-center items-center gap-10 bg-black text-white text-xl px-[40%] py-3 rounded-md'>
                                    login
                                 </motion.div>
                                </motion.div>
                            </div>
            ...
            <div className='hidden text-xl lg:flex gap-11'>
                <Link href={"/"} className='text-lg font-medium'>
                    Home
                </Link>
                <Link href={"/"} className='flex items-end text-lg font-medium'>
                    <p>
                        Shop
                    </p>
                    <span>
            ...
            <div className='items-end hidden h-full gap-4 lg:flex '>
                <div className='flex h-full gap-2 pl-3 rounded-xl'>
                ...
                <Link href={"login"} className='px-12 py-2 text-white bg-black rounded-md'>
                    Login
                </Link>
            </div>
        </div>
...
function Selection1() {
    return (
        <div className='flex justify-center items-center h-screen bg-black rounded-sm overflow-hidden sticky top-0 z-0 mt-[86px]'>
            <Image
                src="/images/G1.jpg"
                alt=""
                width={1920}
                height={1080}
                className='absolute top-0 left-0 z-0 object-cover w-full h-full opacity-85'
            />
            <div className='z-10 flex flex-col items-center justify-center'>
                <div className='text-6xl font-normal text-center text-white' style={Crimson_TextFont.style}>
                    Classic exclusive
                </div>
                <div className='font-bold text-center text-white text-9xl' style={Crimson_TextFont.style}>
                    {`Women's collection`}
                </div>
                <div className='text-5xl font-semibold text-center text-white' style={RobotoFont.style}>
                    {`UPTO 40% OFF`}
                </div>
                <Link href={"/"} className='flex items-center gap-5 px-6 py-3 bg-white rounded-md mt-7'>
...
const CategorieCard = ({ title, img, url }: { title: string, img: string, url: string }) => {
    return (
        <motion.div className='flex  min-w-full justify-center  overflow-hidden items-center h-full relative bg-[#F3F3F3] pb-8'>
            <Image
                src={img}
                alt=""
                width={1900}
...
function Selection2() {
    ...
    const handleScrollLeft = () => {
        if (bodyRef.current) {
            bodyRef.current.scrollLeft -= 300;
        }
    }
    ...
    return (
        <div className='sticky top-0 flex flex-col justify-around min-h-screen gap-10 px-8 overflow-hidden bg-white rounded-sm'>
            <div className='flex items-center justify-between w-full bg-black px-11 h-fit'>
                <div className='z-10 flex flex-col items-start justify-start py-6 '>
                    <p className='text-2xl font-medium text-center text-white' style={RobotoFont.style}>
                        Shop now, save more, enjoy life
                    </p>
                    <p style={CaveatFont.style} className='text-lg font-medium text-center text-white'>
            ...
            <div className='min-h-[80vh] overflow-hidden flex flex-col justify-between'>
                <div className='flex items-center justify-between'>
                    <p style={RobotoFont.style} className='py-6 text-3xl font-semibold'>
                        Shop by Categories
                    </p>
                    <Link href={"/"} className='text-lg font-medium underline' style={InterFont.style}>
                        See all
                    </Link>
                </div>
                <motion.div 
                ...
                ref={bodyRef} className='m-auto h-[calc(80vh-100px)] w-full relative'>
                    <div onClick={handleScrollLeft}  className='absolute md:hidden top-0 left-0 h-full w-[50px] bg-[#ffffff5c] z-10 flex justify-center items-center cursor-pointer'>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M7.93868 13.0599C7.65778 12.7787 7.5 12.3974 7.5 11.9999C7.5 11.6024 7.65778 11.2212 7.93868 10.9399L13.5947 5.2819C13.8761 5.00064 14.2577 4.84268 14.6555 4.84277C14.8525 4.84282 15.0476 4.88167 15.2296 4.9571C15.4116 5.03253 15.5769 5.14307 15.7162 5.2824C15.8554 5.42173 15.9659 5.58713 16.0413 5.76915C16.1166 5.95117 16.1554 6.14625 16.1553 6.34325C16.1553 6.54025 16.1164 6.73531 16.041 6.9173C15.9655 7.09929 15.855 7.26463 15.7157 7.4039L11.1207 11.9999L15.7167 16.5959C15.86 16.7342 15.9744 16.8997 16.0531 17.0826C16.1318 17.2656 16.1732 17.4624 16.1751 17.6616C16.1769 17.8607 16.139 18.0583 16.0637 18.2427C15.9883 18.427 15.877 18.5946 15.7363 18.7355C15.5955 18.8764 15.4281 18.9878 15.2438 19.0633C15.0595 19.1389 14.862 19.1769 14.6628 19.1753C14.4636 19.1736 14.2668 19.1323 14.0837 19.0538C13.9007 18.9753 13.7351 18.8611 13.5967 18.7179L7.93668 13.0599H7.93868Z" fill="black"/>
                        </svg> 
                    </div>
                    <div className='md:grid md:grid-cols-3 flex  md:gap-[25px] h-full  max-w-full overflow-x-scroll relative'>
                    ...
                    <div onClick={handleScrollRight}  className='absolute md:hidden top-0 right-0 h-full w-[50px] bg-[#ffffff5c] z-10 flex justify-center items-center cursor-pointer rotate-180'>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M7.93868 13.0599C7.65778 12.7787 7.5 12.3974 7.5 11.9999C7.5 11.6024 7.65778 11.2212 7.93868 10.9399L13.5947 5.2819C13.8761 5.00064 14.2577 4.84268 14.6555 4.84277C14.8525 4.84282 15.0476 4.88167 15.2296 4.9571C15.4116 5.03253 15.5769 5.14307 15.7162 5.2824C15.8554 5.42173 15.9659 5.58713 16.0413 5.76915C16.1166 5.95117 16.1554 6.14625 16.1553 6.34325C16.1553 6.54025 16.1164 6.73531 16.041 6.9173C15.9655 7.09929 15.855 7.26463 15.7157 7.4039L11.1207 11.9999L15.7167 16.5959C15.86 16.7342 15.9744 16.8997 16.0531 17.0826C16.1318 17.2656 16.1732 17.4624 16.1751 17.6616C16.1769 17.8607 16.139 18.0583 16.0637 18.2427C15.9883 18.427 15.877 18.5946 15.7363 18.7355C15.5955 18.8764 15.4281 18.9878 15.2438 19.0633C15.0595 19.1389 14.862 19.1769 14.6628 19.1753C14.4636 19.1736 14.2668 19.1323 14.0837 19.0538C13.9007 18.9753 13.7351 18.8611 13.5967 18.7179L7.93668 13.0599H7.93868Z" fill="black"/>
                        </svg> 
                    </div>
...
const SesionsCard = ({ title, img, url }: { title: string, img: string, url: string }) => {
    ...
    return (
        <Link href={url} className='flex  justify-center  items-center h-full w-full relative bg-[#000000] p-[20px] pb-[10px] group'
        ...
        >
            ...
            />
            <div className='z-10 flex self-end justify-between'>
                <span className=''>
                    <motion.p
                        variants={titleHover}
                        initial='initial'
                        ...
                        exit='exit'
                        className='text-xl font-medium text-white lg:text-2xl xl:text-4xl' style={RobotoFont.style}>
                        {title}
                    </motion.p>
                    <motion.p
                        ...
                        animate={hover ? 'animate' : 'initial'}
                        exit='exit'
                        className='block text-white xl:text-lg' style={RobotoFont.style}>
...
function Selection3() {
    ...
    return (
        <div className='grid h-screen max-h-screen gap-10 px-8 py-8 overflow-hidden bg-white rounded-sm md:grid-cols-2 mdg:rid-rows-3 rid-rows-4'>
            ...
            <div className='w-full h-full bg-[#000] relative md:row-span-1 row-span-2 cursor-pointer'>
    ...
    return (
        <div className=' rounded-xl w-full h-[620px] '>
            <div className='w-full h-[480px] bg-black group relative'>
                <div className='absolute z-10 hidden right-3 top-3 group-hover:block'>
                    <span className='flex items-center justify-center p-2 bg-white rounded-full cursor-pointer'>
                    ...
                    <span className='flex items-center justify-center p-2 mt-3 bg-white rounded-full cursor-pointer'>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Image
                    ...
                    width={1900}
                    height={1080}
                    className='z-0 object-cover w-full h-full transition-all duration-500 group-hover:opacity-80'
                />
            </div>
            <div className='flex flex-col content-between justify-between gap-2 px-5 py-3'>
...
function Selection4() {
    ...
    return (
        <div className='flex flex-col items-center min-h-screen py-10 overflow-hidden bg-white rounded-sm h-fit gap-28'>
            <div className='flex flex-col items-center gap-20'>
                <p className='text-4xl font-bold px-11'>
                    Our Bestseller
                </p>
                <div className='flex gap-1'>
                    <div className='px-8 py-1 font-medium text-white bg-black rounded-full cursor-pointer' style={InterFont.style}>
                        Men
                    </div>
                    <div className='px-8 py-1 font-medium rounded-full cursor-pointer' style={InterFont.style}>
                        Women
                    </div>
                    <div className='px-8 py-1 font-medium rounded-full cursor-pointer' style={InterFont.style}>
                        Kids
...
function Selection5() {
    ...
    return (
        <div className='sticky top-0 flex flex-col items-center justify-around py-8 overflow-hidden bg-white rounded-sm '>
            <div className='w-full h-[80%] flex x:max-md:flex-col items-start gap-5'>
                <div className='md:w-[60%] h-[calc(100vh-64px)] flex flex-col  gap-10'>
                    <div>
                        ...
                        >
                            <div className='w-full h-[60%] relative bg-black'>
                                <Image
                                    ...
                                    width={1900}
                                    height={1080}
                                    className='absolute top-0 left-0 z-0 object-cover w-full h-full transition-all duration-500 group-hover:opacity-50'
                                />
                                <motion.div
                                    variants={hedden}
                                    initial='initial'
                            ...
                            <div>
                                <p className='mt-4 text-2xl font-medium text-black capitalize' style={RobotoFont.style}>
                                    {`The best summer dresses for every occasion`}
                                </p>
                                <p className='mt-2 text-sm text-black ' style={RobotoFont.style}>
                ...
                <div className='md:w-[40%] h-[calc(100vh-64px)] hidden md:flex relative flex-col py-4  mt-2 mr-11 overflow-hidden justify-between items-center gap-10 bg-black'>
                    <Image
                        ...
                        className='absolute top-0 left-0 z-0 object-cover w-full h-full'
                    />
                    <div className='z-10 flex items-center w-full gap-3 px-5'>
                        <p className='text-xl text-white ' style={RobotoFont.style}>
                            Hot News
                        </p>
                        <div className='line w-[calc(100%-100px)] h-[2px] bg-white' />
                    </div>
                    <div className='z-10 flex items-end justify-between gap-3 px-5'>
                        <div className='z-10 flex flex-col items-start justify-center'>
                            <p className='font-light text-white ' style={RobotoFont.style}>
...
function Footer() {
    return (
        <div className='sticky top-0 pt-8 overflow-hidden bg-black rounded-sm h px-11'>
            <div className='flex items-center justify-between w-full bg-black h-fit'>
                <div className='z-10 flex flex-col items-start justify-start py-6 '>
                    <p className='text-2xl font-medium text-center text-white' style={RobotoFont.style}>
                        Shop now, save more, enjoy life
                    </p>
            ...
            <div className='grid grid-cols-2 mt-11'>
                <div className='flex flex-col items-start justify-start gap-5'>
                    <div>
                        <div className='flex items-center gap-1'>
                            ...
                            />
                            <p className='text-5xl font-medium text-white' style={RobotoFont.style}>
                                GarbGallery
                            </p>
                        </div>
                        <p className='mt-3 text-xl text-white' style={CaveatFont.style}>
                            {`Treat yourself today - you've earned it!Treat yourself today - you've earned it!Treat yourself today`}
                        </p>
                    </div>
                    <div className=''>
                        <p className='text-2xl font-bold text-white' style={RobotoFont.style}>
                            {`Contact Us`}
                        </p>
                        <span className='flex items-center gap-3 mt-5'>
                            ...
                            <p className='text-lg text-white cursor-pointer hover:underline' style={RobotoFont.style}>
                                +212667724196
                            </p>
                        </span>
                        <span className='flex items-center gap-3 mt-5'>
                        ...
                        <span className='flex items-start gap-3 mt-5 '>
                            <span className='pt-1'>
                    ...
                    <div className='grid grid-cols-2 gap-5 '>
                        <div>
                            ...
                            <div className='grid grid-cols-2 gap-2 mt-3'>
                                ...
                                <p className='col-span-2 text-lg text-white cursor-pointer hover:underline' style={RobotoFont.style}>
                                    Careers
                                </p>
                                <p className='text-lg text-white hover:underline cursor-pointe col-span-2r' style={RobotoFont.style}>
                        ...
                        <div className='pr-5'>
                            ...
                            <p className='mt-2 text-white' style={RobotoFont.style}>
                            ...
                            <div className='flex p-3 items-center gap-2 border-[1.5px] border-white rounded-xl mt-3'>
                                ...
                                <input type="text" className='w-full bg-transparent e' placeholder='Your Email' />
                                <span>
                ...
                <div className='w-full h-full overflow-hidden text-white rounded-sm '>
            ...
            <div className='flex items-center justify-between py-4'>
                <p className='text-lg text-white' style={RobotoFont.style}>
                    © 2023 Achraf Sabbar. All Rights Reserved.
                </p>
                <div className='flex items-center gap-3'>
                    <span className='flex items-center gap-3'>
                        <p className='text-white cursor-pointer hover:underline' style={RobotoFont.style}>
                            Privacy Policy
                        </p>
                        <p className='text-white cursor-pointer hover:underline' style={RobotoFont.style}>
                            Terms & Conditions
...
export default function Home() {
    ...
    return (
        <div className='m-auto '>
            <Header />
            <Selection1 />
            <div className='sticky top-0 z-20 min-w-full bg-white'>
